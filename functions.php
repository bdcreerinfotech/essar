...
function essar_setup() {
	/*
		...
		* If you're building a theme based on essar, use a find and replace
		* to change 'essar' to the name of your theme in all the template files.
		*/
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'essar' ),
		)
	);
...
function essar_scripts() {
	...
	wp_style_add_data( 'essar-style', 'rtl', 'replace' );

	wp_enqueue_script( 'essar-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
